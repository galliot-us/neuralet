...
This is a dockerized implementation of the [Coral](https://coral.ai/) Inception V4 for amd64 host with an attached USB coral edge tpu accelerator. [Link to the original model.](https://github.com/google-coral/edgetpu/raw/master/test_data/inception_v4_299_quant_edgetpu.tflite)
