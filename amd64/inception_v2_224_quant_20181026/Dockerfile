...
# 1) build: docker build -t "neuralet/amd64:inception_v2_224_quant_20181026" .
# 2) run: docker run -it --privileged --net=host -v /PATH_TO_CLONED_REPO_ROOT/:/repo neuralet/amd64:inception_v2_224_quant_20181026
...
WORKDIR /repo/amd64/inception_v2_224_quant_20181026
