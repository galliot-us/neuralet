...
This is a dockerized implementation of the [Coral](https://coral.ai/) MobileNet V2 (inat_plant) for amd64 host with an attached USB coral edge tpu accelerator. [Link to the original model.](https://github.com/google-coral/edgetpu/raw/master/test_data/mobilenet_v2_1.0_224_inat_plant_quant_edgetpu.tflite)
