...
# 1) build: docker build -t "neuralet/amd64:mobilenet_v2_1.0_224_inat_insect" .
# 2) run: docker run -it --privileged --net=host -v /PATH_TO_CLONED_REPO_ROOT/:/repo neuralet/amd64:mobilenet_v2_1.0_224_inat_insect
...
WORKDIR /repo/amd64/mobilenet_v2_1.0_224_inat_insect
