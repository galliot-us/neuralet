...
# 1) build: docker build -t "neuralet/coral-dev-board:mobilenet_ssd_v2_face" .
# 2) run: docker run -it --privileged --net=host -v /PATH_TO_CLONED_REPO_ROOT/:/repo neuralet/coral-dev-board:mobilenet_ssd_v2_face
...
WORKDIR /repo/coral-dev-board/mobilenet_ssd_v2_face/
