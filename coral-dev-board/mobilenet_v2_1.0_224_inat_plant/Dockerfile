...
# 1) build: docker build -t "neuralet/coral-dev-board:mobilenet_v2_1.0_224_inat_plant" .
# 2) run: docker run -it --privileged --net=host -v /PATH_TO_CLONED_REPO_ROOT/:/repo neuralet/coral-dev-board:mobilenet_v2_1.0_224_inat_plant
...
WORKDIR /repo/coral-dev-board/mobilenet_v2_1.0_224_inat_plant
