# Coral Inception V3 model:
This is a dockerized implementation of the [Coral](https://coral.ai/) Inception V3 for google's [Coral Dev Board](https://coral.ai/products/dev-board/) devices. [Link to the original model.](https://github.com/google-coral/edgetpu/raw/master/test_data/inception_v3_299_quant_edgetpu.tflite)
