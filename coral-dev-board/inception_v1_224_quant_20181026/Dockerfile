...
# 1) build: docker build -t "neuralet/coral-dev-board:inception_v1_224_quant_20181026" .
# 2) run: docker run -it --privileged --net=host -v /PATH_TO_CLONED_REPO_ROOT/:/repo neuralet/coral-dev-board:inception_v1_224_quant_20181026
...
WORKDIR /repo/coral-dev-board/inception_v1_224_quant_20181026
