# Coral Inception V1 model:
This is a dockerized implementation of the [Coral](https://coral.ai/) Inception V1 for google's [Coral Dev Board](https://coral.ai/products/dev-board/) devices. [Link to the original model.](https://github.com/google-coral/edgetpu/raw/master/test_data/inception_v1_224_quant_edgetpu.tflite)

In 2014 google announced GoogleNet (inception V1) [link to paper](https://arxiv.org/abs/1409.4842). Inception module contains 1×1 Convolutions in the middle of the network. Also the network leverages global average pooling at the end instead of using fully connected layers.
...
MODEL_NAME=inception_v1_224_quant_20181026
